...
export class Init1753093636041 implements MigrationInterface {
    name = 'Init1753093636041'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "mileage_token" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, "contract_address" character varying NOT NULL, "symbol" character varying NOT NULL, "image_url" character varying NOT NULL, "transaction_status" "public"."mileage_token_transaction_status_enum" NOT NULL DEFAULT 'PROCESSING', "transaction_hash" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_d7a7add8f17ee14570c5c1008d7" PRIMARY KEY ("id"))`);
